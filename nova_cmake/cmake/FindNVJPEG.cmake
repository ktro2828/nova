...
if(NVJPEG_FOUND)
  ...
  message(DEBUG "nvJPEG found in ${NVJPEG_INCLUDE_DIR}")
  if(NVJPEG_DECOUPLED_API)
    message(DEBUG "nvJPEG is using new API")
  else()
    message(
      FATAL_ERROR
  ...
  if(NVJPEG_LOSSLESS_SUPPORTED)
    message(DEBUG "nvJPEG lossless supported")
  else()
    message(DEBUG "nvJPEG lossless NOT supported")
  endif()
else()
  message(DEBUG "nvJPEG NOT found")
endif()
